...
if(__name__ == "__main__"):
    citMatrixFilePath = os.path.join(toolkit.variables.RESULT_DIR, 'pubmed_citation_lda', 'pubmed_citation_lda_500_145317_145317_0.001_0.001_timeCtrl_10_10.lda_citMatrix');
...
#    topicSummaryFilePath = os.path.join(toolkit.variables.RESULT_DIR, 'pubmed_citation_lda', 'pubmed_citation_lda_100_145317_145317_0.001_0.001_timeCtrl_30_45.lda_summary');
#    citMatrix = theme_discovery.citation_based_method.readCitMatrixSummary(citMatrixFilePath);
#    topicSummaryDict = theme_discovery.citation_based_method.readTopicSummary(topicSummaryFilePath);
