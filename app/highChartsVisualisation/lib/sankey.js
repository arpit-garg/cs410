...
var sankey = function() {
  ...
  function computeNodeLinks() {
    ...
    var copyNodes = _.cloneDeep(nodes)
    console.log('Length before : ' + nodes.length)

//    for(var i=0;i<nodes.length;) {
//      console.log(i + " " + nodes[i].sourceLinks.length + " " + nodes[i].targetLinks.length);
//      if((nodes[i].sourceLinks.length + nodes[i].targetLinks.length) <= 2) { //indegree+outdegree < 1
//        console.log('Removing node : ' + i )
//        console.log(nodes[i].topic)
//        nodes.splice(i,1);
//      }
//      else {
//        i++;
...
//    }
//    // nodes = copyNodes
//    console.log('Length after : ' + nodes.length)
  }
...
//
//    for(var i=0;i<nodes.length;) {
//      console.log(i + " " + nodes[i].sourceLinks.length);
//      if(nodes[i].value < 1) { //indegree+outdegree < 1
//        console.log(nodes[i].topic)
//        nodes.splice(i,1);
//      }
//      else {
    ...
    while (remainingNodes.length) {
      ...
      remainingNodes.forEach(function(node) {
        ...
        node.sourceLinks.forEach(function(link) {
          ...
          if (nextNodes.indexOf(link.target) < 0 && visitedNodes.indexOf(link.target) < 0) {
            nextNodes.push(link.target);
          }
        });
      });
      visitedNodes = visitedNodes.diff(nextNodes);
