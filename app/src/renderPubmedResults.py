...
def writeGraphToJson(topicDependencyGraph, idToPmid, metaFileDict):
    ...
    timeSortedSummaryFile = '/Users/arpitgarg/Documents/UIUC/MSIM/spring17/cs410/Project/sifaka.cs.uiuc.edu/~xwang95/citation_lda/pubmed_citation_lda_500_145317_145317_0.001_0.001_timeCtrl_30_45.lda_summary_timeSorted_shortSummary'
    ...
    df = df.drop(['weight', 'std','topicMilestonePaperLink'], axis=1)
...
if __name__ == '__main__':
    ...
    # ldaSummaryFilePath = '/Users/akhilaggarwal/Documents/Development/cs410/data/pubmed_citation_lda_500_145317_145317_0.001_0.001_timeCtrl_30_45.lda'
