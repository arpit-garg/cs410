...
refTag = re.compile(
    '<ref id="(.*?)">.*?<article-title.*?>(.*?)</article-title>.*?<pub-id pub-id-type="pmid">(.*?)</pub-id>',
    re.DOTALL);
...
if (__name__ == '__main__'):
    ...
    pubmedCitContextFilePathLst = [pubmedCitContextFilePathA_B, pubmedCitContextFilePathC_H,
                                   pubmedCitContextFilePathI_N, pubmedCitContextFilePathO_Z];
